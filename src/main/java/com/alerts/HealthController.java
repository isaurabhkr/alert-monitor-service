...
/**
 * A very basic Health controller which returns the hostname.
 *
 * @author kim
 *
 */
...
public class HealthController {
	...
	private static final Logger LOG = getLogger(HealthController.class.getName());
